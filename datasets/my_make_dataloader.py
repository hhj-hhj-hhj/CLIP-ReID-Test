...
def make_dataloader(cfg):
    ...
    train_set = ImageDataset(dataset.train_all, train_transforms)
    train_set_normal = ImageDataset(dataset.train_all, val_transforms)
    num_classes = dataset.num_train_rgb_pids
    cam_num = dataset.num_train_rgb_cams + dataset.num_train_ir_cams
    view_num = dataset.num_train_rgb_vids
